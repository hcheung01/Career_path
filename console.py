#!/usr/bin/python3
"""
Command interpreter for Career Path project
"""
import cmd
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_Skill(self, arg):
        """class method with .function() syntax
        Usage: Skill.<command>(<id>)"""
        self.__parse_exec('Skill', arg)

    def do_Profile(self, arg):
        """class method with .function() syntax
        Usage: Profile.<command>(<id>)"""
        self.__parse_exec('Profile', arg)

    def do_Job(self, arg):
        """class method with .function() syntax
        Usage: Job.<command>(<id>)"""
        self.__parse_exec('Job', arg)
